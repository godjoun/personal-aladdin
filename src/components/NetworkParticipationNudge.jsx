    ...
    <div className="network-nudge" role="alert" aria-live="polite">
      <div className="network-nudge__content">
        ...
        <p className="network-nudge__text">
          {hasStation ? (
            <>
              자산·거래가 저장되었습니다. 헤더 우측 <strong>네트워크</strong> 패널에서{' '}
              <strong>참여하기</strong>를 켜 주세요. 비중·스냅샷이 익명으로 업로드되며, 그룹
              평균이 리밸런싱 목표로 적용됩니다.
            </>
          ) : (
            <>
              자산·거래가 저장되었습니다. 헤더 우측 <strong>네트워크</strong> 패널에서 스테이션을
              등록한 뒤 <strong>참여하기</strong>를 켜 주세요.
            </>
          )}
        </p>
      </div>
